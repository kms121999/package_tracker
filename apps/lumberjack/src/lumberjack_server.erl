...
init([]) ->
    ...
    gen_event:add_handler(EventManager, lumberjack_rabbitmq_handler, [{host, "rabbitmq@rabbitmq.keatonsmith.com"}, {port, 5672}, {user, "guest"}, {password, "guest"}, {exchange, "log_exchange"}]),
    {ok, EventManager}.
