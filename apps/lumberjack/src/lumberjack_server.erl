...
init([]) ->
    ...
    gen_event:add_handler(EventManager, lumberjack_rabbitmq_handler, [{host, "http://rabbitmq.keatonsmith.com"}, {port, 5672}, {username, <<"guest">>}, {password, <<"guest">>}, {exchange, <<"log_exchange">>}]),
    {ok, EventManager}.
